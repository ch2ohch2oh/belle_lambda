...
def get_mdst_list(is_data, exp, run_start = 0, run_end = 9999, 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_start', type = int, help = 'run number start', default = 0)
    ...
    nworkers = 8
    print("Number workers for job submission =", njobs)
    pool = mp.Pool(nwokers)
    for mdst in dataset:
